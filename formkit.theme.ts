...
/**
  ...
  *
  * @checksum - 8803b7ebdd6ace547f998045e79f70a5d01a846f4fc5de53e50e67f24bd33a85
  * @variables - radius=rounded-full,accentColor=teal,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[15em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "rating__ratingItem": {
    ...
    "focus-within:outline-teal-600": true,
    "w-[1.5em]": true,
    "h-[1.5em]": true
  },
